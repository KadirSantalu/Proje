...
if ($Urun->rowCount()==1) {
 ...
 ?>
	...
	<section class="product-section">
		<div class="container">
			<div class="back-link">
				<a href="./category.html"> &lt;&lt; Kategoriye Geri Dön</a>
			</div>
			<div class="row">
				<div class="col-lg-6">
				...
				<div class="col-lg-6 product-details">
					...
					<h4 class="p-stock">Mevcut: <span>Stokta</span></h4>
					<div class="p-rating">
					...
					<div class="p-review">
						<a href="">3 yorum </a>|<a href="">Yorumunuzu ekleyin</a>
					</div>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="footer-widget about-widget">
						...
						<ul>
							...
							<li><a href="">Siparişleri Takip Et</a></li>
							<li><a href="">İadeler</a></li>
							<li><a href="">İşler</a></li>
							<li><a href="">Gönderme</a></li>
							<li><a href="">Blog</a></li>
						</ul>
						<ul>
							<li><a href="">Ortaklar</a></li>
							<li><a href="">Blogcular</a></li>
							<li><a href="">Destek</a></li>
							<li><a href="">Kullanım Şartları</a></li>
							<li><a href="">Basmak</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
						...
						<div class="fw-latest-post-widget">
							<div class="lp-item">
								...
								<div class="lp-content">
									<h6>Hangi ayakkabıyı giymeliyim?</h6>
							...
							<div class="lp-item">
								...
								<div class="lp-content">
									<h6>Bu yılın trendleri</h6>
									<span>Mayıs 16, 2023</span>
									<a href="#" class="readmore">Devamını oku</a>
								</div>
							</div>
						</div>
...
<p class="text-white text-center mt-5">Telif Hakkı &copy;<script>document.write(new Date().getFullYear());</script> Tüm hakları saklıdır | Bu şablon ile yapılmıştır<i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Abdülkadir Santalu</a></p>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
